    ...
    Try {
        ...
        if ($Force -or -Not (Test-Path -Path $InstallPathwIart )) {
            ...
            if ($getKMITTestStep) { 
                ...
                Invoke-WebRequest -Uri "https://raw.githubusercontent.com/$RepoOwner/atomic-red-team/kmit/kmit/1st/KMIT_PoC_Test.ps1" -OutFile "$DownloadPath\1st\KMIT_PoC_Test.ps1"
