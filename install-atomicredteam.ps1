    ...
    Try {
        ...
        if ($Force -or -Not (Test-Path -Path $InstallPathwIart )) {
            ...
            if ($getRound5TestStep) { 
                ...
                Invoke-WebRequest -Uri "https://raw.githubusercontent.com/$RepoOwner/atomic-red-team/round5test/round5test/2nd/Round5TestStep(AD)_2.ps1" -OutFile "$DownloadPath\Round5TestStep(AD)_2.ps1"
                Invoke-WebRequest -Uri "https://raw.githubusercontent.com/$RepoOwner/atomic-red-team/round5test/round5test/2nd/Round5TestStep(linux)_2.ps1" -OutFile "$DownloadPath\Round5TestStep(linux)_2.ps1"
                Invoke-WebRequest -Uri "https://raw.githubusercontent.com/$RepoOwner/atomic-red-team/round5test/round5test/2nd/Round5TestStep(manual)_2.txt" -OutFile "$DownloadPath\Round5TestStep(manual)_2.txt"
                Invoke-WebRequest -Uri "https://raw.githubusercontent.com/$RepoOwner/atomic-red-team/round5test/round5test/2nd/Round5TestStep_2.ps1" -OutFile "$DownloadPath\Round5TestStep_2.ps1"
                Invoke-WebRequest -Uri "https://raw.githubusercontent.com/$RepoOwner/atomic-red-team/round5test/round5test/2nd/Round5TestStep_privilege_2.ps1" -OutFile "$DownloadPath\Round5TestStep_privilege_2.ps1" 
            }
